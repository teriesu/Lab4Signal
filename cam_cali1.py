...
images = glob.glob('Images/im_1/*.png') #Read the images
for fname in images:
...
np.savez("parameters1.npz",mtx=mtx,dist=dist,rvecs=rvecs,tvecs=tvecs)
np.savez("points1.npz",objpoints=objpoints,imgpoints=imgpoints)
